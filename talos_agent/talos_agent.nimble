...
task test, "Run all tests":
  ...
  exec "nim c --path:src --path:../talos_core/src --path:../talos_core/tests -r tests/test_discord_mocks.nim"
  exec "nim c --path:src --path:../talos_core/src --path:../talos_core/tests -r tests/test_discord_commands.nim"
  exec "nim c --path:src --path:../talos_core/src --path:../talos_core/tests -r tests/test_discord_bot.nim"
  exec "nim c --path:src --path:../talos_core/src --path:../talos_core/tests --threads:on -r tests/test_e2e_discord.nim"
  exec "nim c --path:src --path:../talos_core/src --path:../talos_core/tests -r tests/test_discord_config.nim"
  exec "nim c --path:src --path:../talos_core/src --path:../talos_core/tests -r tests/test_thread_mapping.nim"
  exec "nim c --path:src --path:../talos_core/src --path:../talos_core/tests -r tests/test_thread_reconnection.nim"
  exec "nim c --path:src --path:../talos_core/src --path:../talos_core/tests --threads:on -r tests/test_daemon_delegation.nim"
